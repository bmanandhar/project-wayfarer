    ...
    render() {
        return(
            <div className="post-and-img">
                <img className="london-post-img" src="https://upload.wikimedia.org/wikipedia/commons/8/87/Palace_of_Westminster_from_the_dome_on_Methodist_Central_Hall.jpg" alt=""></img>
                <div>
